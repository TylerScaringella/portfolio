  ...
  return (
    <main className="flex-auto min-w-0 mt-6 flex flex-col px-2 md:px-0">
      ...
      <section>
        ...
        <p className="text-sm text-white">I'm a second-year college student with a passion for computer science who is fasincated by interdiscinplinary topics. I am highly motivated to apply programming to create real world solutions.</p>
